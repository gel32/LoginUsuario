...
<html lang="<?php echo $language; ?>">
  ...
  <body>
    ...
    <?php elseif ($language == 'en'): ?>
      <p class="text"><strong>Mensaje de prueba</strong></p>
      <p class="text">Holaaaaaaaaa &amp; launched and is now all set to serve your web content. This placeholder page<sup><a href="#footnote-1">1</a></sup> should be replaced or deleted.</p>
      <p class="text">
